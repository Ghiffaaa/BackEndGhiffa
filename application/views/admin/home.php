                ...
                <div>
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2">
                            <a href="<?= base_url('admin') ?>" class="nav-link d-flex align-items-center gap-3 active">
                                <i class="fas fa-home sidebar-icon"></i>Dashboard
                            </a>
                        </li>
                        <li class="nav-item mb-2">
                            <a href="<?= base_url('admin/page_tambah_data') ?>" class="nav-link d-flex align-items-center gap-2">
                        ...
                        <div class="card text-center" style="height: 200px;">
                            <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                <div class="text-white">
                                    <h5 class="mt-2 mb-1">Selamat Datang di Dashboard Admin,</h5>
                                    <p>Hak Akses : Menambah dan mengedit data mahasiswa.</p>
                                </div>
                            </div>
                        </div>
                    </div>
