...
<head>
    ...
    <title>Dashboard Mahasiswa - Home</title>
                ...
                <div>
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2">
                            <a href="<?= base_url('mahasiswa') ?>" class="nav-link d-flex align-items-center gap-3 active">
                                <i class="fas fa-home sidebar-icon"></i>Dashboard
                            </a>
                        </li>
                        <li class="nav-item mb-2">
                            <a href="<?= base_url('mahasiswa/page_nilai') ?>" class="nav-link d-flex align-items-center gap-2">
                        ...
                        <div class="card text-center" style="height: 200px;">
                            <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                <div class="text-white">
                                    <h5 class="mt-2 mb-1">Selamat Datang di Dashboard Mahasiswa,</h5>
                                    <p>Hak Akses : Melihat seluruh rekap nilai.</p>
                                </div>
                            </div>
                        </div>
                    </div>
